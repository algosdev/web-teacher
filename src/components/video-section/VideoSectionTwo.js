...
const items = [
  ...
  {
    title: "Masofaviy o'rganish",
    info: 'Bu siz xohlagan vaqt va joy degani!',
    icon: 'icon-square'
  },
  {
    title: 'Sinov testlari',
    info: "Mavzuni o'zlashtirganingizni sinov testlari yordamida tekshiring",
    icon: 'icon-research'
  },
  {
    title: 'Talabchan tartib',
    info: "Mavzuni o'zlashtirish uchun yetarli vaqt o'tmaguncha yakunlay olmaysiz!",
    icon: 'icon-clock'
  }
];
            ...
            <div className="feature-thumbnail">
              <div className="main-image video-popup-wrapper video-popup-two">
                <img
                  ...
                  src={`${process.env.PUBLIC_URL}./images/banner/banner-01/learner.jpeg`}
